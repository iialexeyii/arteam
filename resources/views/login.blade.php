<? $levelst = ["global/plugins/select2/select2.css", "admin/pages/css/login-soft.css"]; ?>
...
<div class="content">
	...
	{!! Form::open(["url" => "/login", "class" => "login-form"]) !!}
		<h3 class="form-title">Вход в ваш аккаунт</h3>
		<div class="alert alert-danger display-hide">
			<button class="close" data-close="alert"></button>
			<span>
			Введите логин и пароль </span>
		</div>
	...
	{!! Form::open(["url" => "/newuser", "class" => "register-form"]) !!}
		...
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Re-type Your Пароль</label>
			<div class="controls">
				<div class="input-icon">
					<i class="fa fa-check"></i>
					<input class="form-control placeholder-no-fix" type="password" autocomplete="off" placeholder="Re-type Your Пароль" name="rpassword"/>
				</div>
			</div>
		</div>
		<div class="form-group">
...
{!! Html::script( asset('public/assets/global/plugins/jquery-validation/js/jquery.validate.min.js')) !!}
{!! Html::script( asset('public/assets/global/plugins/backstretch/jquery.backstretch.min.js')) !!}

{!! Html::script( asset('public/assets/global/plugins/select2/select2.min.js')) !!}
{!! Html::script( asset('public/assets/global/plugins/select2/select2_locale_ru.js')) !!}
...
{!! Html::script( asset('public/assets/admin/pages/scripts/login-soft.js')) !!}
...
jQuery(document).ready(function() {     
  ...
  Demo.init();
       ...
       $.backstretch([
        "public/assets/admin/pages/media/bg/1.jpg",
        "public/assets/admin/pages/media/bg/2.jpg",
        "public/assets/admin/pages/media/bg/3.jpg",
        "public/assets/admin/pages/media/bg/4.jpg"
        ], {
          fade: 1000,
          duration: 8000
    }
